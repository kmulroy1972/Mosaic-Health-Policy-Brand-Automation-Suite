...
import { semanticSearch, type SemanticSearchRequest } from './semantic';


/**
 * HTTP trigger for semantic search.
 * POST /api/search/query
 */
export async function semanticSearchHttpTrigger(
  request: HttpRequest,
  ...
  try {
    ...
    const result = await semanticSearch(body, context);
